...
- **Excluded from asset-class aggregates:** the 128 individual stocks and sector ETFs
  — to avoid double-counting (they are represented in the sector files instead).
