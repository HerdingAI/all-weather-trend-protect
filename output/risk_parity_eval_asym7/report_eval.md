...
- **TRAIN rank:** #1 (TRAIN score 80.9, z = +2.78)
...
- **Deflated Sharpe (annualized): -1.351**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| MinVar | 6 | 0.886 | -33.21% | -17.63% | 1.456 | 65.2 | 43 |
| ERC | 4 | 0.855 | -33.49% | -17.42% | 1.460 | 63.7 | 45 |
| EW-Infl-DurL | 1 | 0.609 | -36.85% | -23.90% | n/a | 60.3 | 35 |
| EW-Infl-DurL2 | 2 | 0.597 | -38.18% | -23.84% | n/a | 58.9 | 29 |
| EW-Infl-Both | 1 | 0.524 | -50.39% | -24.39% | n/a | 56.2 | 25 |
| EW-Infl-BothL | 5 | 0.561 | -46.25% | -22.64% | n/a | 54.6 | 27 |
| EW-Hedge-Dur-DD | 2 | 0.667 | -27.32% | -18.80% | n/a | 53.2 | 25 |
| EW-Hedge-Dur-DD2 | 2 | 0.667 | -27.32% | -18.80% | n/a | 53.2 | 25 |
| EW-Hedge-DD | 1 | 0.617 | -31.08% | -19.87% | n/a | 52.7 | 40 |
| LS-TSMOM | 26 | 0.205 | -13.08% | -27.69% | n/a | 43.5 | 17 |

## 6. Overfit diagnostics

| Diagnostic | Value | Reading |
|---|---:|---|
| TRAIN score mean / std | 50.0 / 11.1 | field dispersion |
| Winner TRAIN score (z) | +2.78 | OUTLIER — overfit risk |
...
- Rolling Deflated Sharpe = -0.939  (P>0 = 0.00)
...
| EW-AsymMA-Tight | US Equity, Preferred Stock, US Corporate Bonds, EM Bonds, Silver | 4.98% | **0.569** | -17.18% | -16.46% | -0.090 | -0.053 | -0.066 | 1.00 | 0.00% | -0.74 | [-0.15, 1.29] |
...
- Net ann ret 4.98% · Sharpe 0.569 · MaxDD -17.18% · both-down -16.46% · Upβ -0.090 / Dnβ -0.053 · Dn-corr -0.066 · gross 1.00 · lev cost 0.00%/yr · DSR -0.74 · Sharpe CI [-0.15, 1.29]
...
- Net ann ret 7.30% · Sharpe 0.526 · MaxDD -30.53% · both-down -36.21% · Upβ 0.656 / Dnβ 0.853 · Dn-corr 0.636 · gross 0.90 · lev cost 0.00%/yr · DSR -0.78 · Sharpe CI [-0.00, 1.36]
