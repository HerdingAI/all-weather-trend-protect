...
- **TRAIN rank:** #1 (TRAIN score 82.6, z = +3.13)
...
- **Deflated Sharpe (annualized): -1.447**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| LS-TSMOM | 50 | 0.116 | -7.49% | -21.23% | n/a | 51.0 | 26 |

## 6. Overfit diagnostics

| Diagnostic | Value | Reading |
|---|---:|---|
| TRAIN score mean / std | 50.0 / 10.4 | field dispersion |
| Winner TRAIN score (z) | +3.13 | OUTLIER — overfit risk |
| Top-10 TRAIN in Top-20 TEST | 0% | selection stability |
| Spearman TRAIN↔TEST score | -0.60 | rank persistence |
...
- Rolling Deflated Sharpe = -1.108  (P>0 = 0.00)
...
|---|---:|---:|---:|
| Ann return (net) | 6.03% | 7.00% | **0.67%** |
| Ann vol | 7.79% | 5.44% | **9.01%** |
| Net Sharpe | 0.774 | 1.287 | **0.075** |
| Max DD | -16.26% | -8.97% | **-23.28%** |
| Both-down ann ret | -29.27% | -15.16% | **-9.46%** |
| Both-down hit rate | 4.17% | 16.67% | **37.50%** |
| Corr w/ equity | 0.827 | 0.707 | **0.135** |
| Crisis avg ret | -5.28% | -2.11% | **-2.75%** |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| RP winner | US Equity, US Treasuries, US Municipal Bonds, Gold, Silver, Currency | 7.00% | **1.287** | -8.97% | -15.16% | 0.189 | 0.277 | 0.575 | 1.00 | 0.00% | — | — |
...
| TG-Short | International Equity, US Treasuries, US Corporate Bonds, US Municipal Bonds, EM Bonds, Silver, Commodities, Currency | 2.79% | **0.768** | -7.51% | -8.60% | 0.058 | 0.103 | 0.266 | 1.00 | 0.00% | -0.54 | [0.05, 1.59] |
| TG-Short-6m | US Equity, US REIT, US Treasuries, US Corporate Bonds, US Municipal Bonds, Silver, Commodities, Currency | 3.19% | **0.752** | -8.42% | -8.28% | 0.022 | 0.172 | 0.351 | 1.00 | 0.00% | -0.56 | [0.08, 1.57] |
| TrendGate | International Equity, US Treasuries, US Corporate Bonds, US Municipal Bonds, EM Bonds, Silver, Commodities, Currency | 2.97% | **0.740** | -9.40% | -10.66% | 0.098 | 0.179 | 0.423 | 1.00 | 0.00% | -0.57 | [0.04, 1.60] |
| TG-Short-LS | International Equity, Preferred Stock, US Treasuries, US Corporate Bonds, US Municipal Bonds, EM Bonds, Commodities, Currency | 2.40% | **0.647** | -7.78% | -5.83% | 0.004 | 0.069 | 0.166 | 1.20 | 1.16% | -0.66 | [-0.01, 1.41] |
...
**TrendGate** — combo: International Equity, US Treasuries, US Corporate Bonds, US Municipal Bonds, EM Bonds, Silver, Commodities, Currency

- Net ann ret 2.97% · Sharpe 0.740 · MaxDD -9.40% · both-down -10.66% · Upβ 0.098 / Dnβ 0.179 · Dn-corr 0.423 · gross 1.00 · lev cost 0.00%/yr · DSR -0.57 · Sharpe CI [0.04, 1.60]
...
- Net ann ret 2.79% · Sharpe 0.768 · MaxDD -7.51% · both-down -8.60% · Upβ 0.058 / Dnβ 0.103 · Dn-corr 0.266 · gross 1.00 · lev cost 0.00%/yr · DSR -0.54 · Sharpe CI [0.05, 1.59]
...
**TG-Short-LS** — combo: International Equity, Preferred Stock, US Treasuries, US Corporate Bonds, US Municipal Bonds, EM Bonds, Commodities, Currency

- Net ann ret 2.40% · Sharpe 0.647 · MaxDD -7.78% · both-down -5.83% · Upβ 0.004 / Dnβ 0.069 · Dn-corr 0.166 · gross 1.20 · lev cost 1.16%/yr · DSR -0.66 · Sharpe CI [-0.01, 1.41]
...
**TG-Short-6m** — combo: US Equity, US REIT, US Treasuries, US Corporate Bonds, US Municipal Bonds, Silver, Commodities, Currency

- Net ann ret 3.19% · Sharpe 0.752 · MaxDD -8.42% · both-down -8.28% · Upβ 0.022 / Dnβ 0.172 · Dn-corr 0.351 · gross 1.00 · lev cost 0.00%/yr · DSR -0.56 · Sharpe CI [0.08, 1.57]
