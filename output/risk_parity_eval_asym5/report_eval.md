...
- **TRAIN rank:** #1 (TRAIN score 78.6, z = +2.50)
...
- **Deflated Sharpe (annualized): -1.350**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| InvVol | 2 | 0.774 | -34.41% | -18.45% | 1.493 | 57.5 | 42 |
| MinVar | 17 | 0.816 | -33.42% | -18.35% | 1.431 | 56.1 | 30 |
| InvVar | 2 | 0.773 | -34.19% | -18.30% | 1.490 | 55.4 | 38 |
| ERC | 15 | 0.810 | -32.89% | -17.79% | 1.439 | 54.2 | 32 |
| LS-TSMOM | 14 | 0.191 | -11.24% | -26.73% | n/a | 39.8 | 9 |
...
| Winner TRAIN score (z) | +2.50 | OUTLIER — overfit risk |
| Top-10 TRAIN in Top-20 TEST | 0% | selection stability |
| Spearman TRAIN↔TEST score | -0.25 | rank persistence |
...
- Rolling Deflated Sharpe = -0.923  (P>0 = 0.00)
