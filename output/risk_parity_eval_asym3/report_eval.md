...
- **TRAIN rank:** #1 (TRAIN score 75.0, z = +2.12)
...
- **Deflated Sharpe (annualized): -0.617**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| InvVol | 6 | 0.828 | -31.65% | -16.26% | 1.522 | 55.0 | 35 |
| InvVar | 4 | 0.813 | -32.36% | -16.66% | 1.512 | 53.0 | 36 |
| MinVar | 21 | 0.864 | -31.35% | -16.61% | 1.443 | 52.1 | 23 |
| ERC | 19 | 0.864 | -29.95% | -15.75% | 1.458 | 48.1 | 23 |
...
| Spearman TRAIN↔TEST score | +0.40 | rank persistence |
...
- Rolling Deflated Sharpe = -0.877  (P>0 = 0.01)
