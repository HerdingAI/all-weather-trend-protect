...
- **TRAIN rank:** #1 (TRAIN score 80.5, z = +2.64)
...
- Trials run on TRAIN: **90144**.
- Raw OOS net Sharpe: **0.227**.
- Expected max null Sharpe over 90144 trials: 1.589 (annualized).
- **Deflated Sharpe (annualized): -1.363**  (raw minus the luck-of-many-trials benchmark).
...
> - **Effective N ≪ nominal N.** DSR's penalty uses N = 90144 independent trials, but the trials share sleeves (any two portfolios holding US Treasuries are correlated), so the *effective* independent-
...
|---|---:|---:|---:|---:|---:|---:|---:|
| MinVar | 12 | 0.843 | -32.69% | -18.09% | 1.438 | 62.8 | 39 |
| ERC | 8 | 0.828 | -32.56% | -17.68% | 1.460 | 61.8 | 40 |
| EW-DDStop-Short | 1 | 0.617 | -31.05% | -19.89% | n/a | 51.2 | 24 |
| EW-Hedge-DD | 1 | 0.617 | -31.05% | -19.89% | n/a | 51.2 | 19 |
| EW-Hedge-Dur-DD | 4 | 0.646 | -28.63% | -17.34% | n/a | 45.5 | 18 |
| EW-Hedge-Dur-DD2 | 4 | 0.646 | -28.63% | -17.34% | n/a | 45.5 | 18 |
| LS-TSMOM | 20 | 0.205 | -11.24% | -26.82% | n/a | 41.8 | 14 |
...
| Winner TRAIN score (z) | +2.64 | OUTLIER — overfit risk |
| Top-10 TRAIN in Top-20 TEST | 0% | selection stability |
| Spearman TRAIN↔TEST score | -0.69 | rank persistence |
| Winner Sharpe test−train | -0.073 | large negative ⇒ overfit |
| Winner both-down test−train | -0.1148 | large negative ⇒ overfit |
| Effective N (vs nominal 90144) | 1.6 | DSR penalty is conservative (trials correlated) |
...
- Rolling Deflated Sharpe = -0.935  (P>0 = 0.00)
...
| EW-AsymMA-Tight | Preferred Stock, US Treasuries, US Corporate Bonds, EM Bonds, Commodities | 3.36% | **0.561** | -10.84% | -14.75% | 0.072 | 0.252 | 0.406 | 1.00 | 0.00% | -0.75 | [-0.08, 1.41] |
...
| EW-Hedge-DMA-2 | Preferred Stock, US Treasuries, US Corporate Bonds, EM Bonds, Commodities | 1.69% | **0.247** | -15.52% | -19.01% | 0.104 | 0.407 | 0.543 | 1.00 | 0.00% | -1.06 | [-0.32, 1.14] |
...
| EW-Short-LS | US REIT, US Treasuries, US Corporate Bonds, EM Bonds, Commodities | 1.86% | **0.233** | -17.63% | -20.13% | 0.003 | 0.517 | 0.553 | 1.20 | 1.16% | -1.08 | [-0.33, 1.18] |
...
**EW-Short-LS** — combo: US REIT, US Treasuries, US Corporate Bonds, EM Bonds, Commodities

- Net ann ret 1.86% · Sharpe 0.233 · MaxDD -17.63% · both-down -20.13% · Upβ 0.003 / Dnβ 0.517 · Dn-corr 0.553 · gross 1.20 · lev cost 1.16%/yr · DSR -1.08 · Sharpe CI [-0.33, 1.18]
...
- Net ann ret 3.36% · Sharpe 0.561 · MaxDD -10.84% · both-down -14.75% · Upβ 0.072 / Dnβ 0.252 · Dn-corr 0.406 · gross 1.00 · lev cost 0.00%/yr · DSR -0.75 · Sharpe CI [-0.08, 1.41]
...
**EW-Hedge-DMA-2** — combo: Preferred Stock, US Treasuries, US Corporate Bonds, EM Bonds, Commodities

- Net ann ret 1.69% · Sharpe 0.247 · MaxDD -15.52% · both-down -19.01% · Upβ 0.104 / Dnβ 0.407 · Dn-corr 0.543 · gross 1.00 · lev cost 0.00%/yr · DSR -1.06 · Sharpe CI [-0.32, 1.14]
