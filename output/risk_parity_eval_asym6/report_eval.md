...
- **TRAIN rank:** #1 (TRAIN score 81.5, z = +2.76)
...
- **Deflated Sharpe (annualized): -1.341**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| ERC | 4 | 0.855 | -33.49% | -17.42% | 1.460 | 64.5 | 43 |
| MinVar | 8 | 0.896 | -31.42% | -16.79% | 1.464 | 64.1 | 44 |
| EW-Hedge-Dur-DD | 5 | 0.678 | -26.30% | -18.48% | n/a | 53.9 | 26 |
| EW-Hedge-Dur-DD2 | 5 | 0.678 | -26.30% | -18.48% | n/a | 53.9 | 26 |
| EW-DDStop-Short | 1 | 0.617 | -31.08% | -19.87% | n/a | 53.4 | 31 |
| EW-Hedge-DD | 1 | 0.617 | -31.08% | -19.87% | n/a | 53.4 | 24 |
| LS-TSMOM | 26 | 0.219 | -12.76% | -27.27% | n/a | 43.6 | 17 |
...
| Winner TRAIN score (z) | +2.76 | OUTLIER — overfit risk |
| Top-10 TRAIN in Top-20 TEST | 10% | selection stability |
| Spearman TRAIN↔TEST score | -0.59 | rank persistence |
...
- Rolling Deflated Sharpe = -0.929  (P>0 = 0.00)
...
| EW-Short-LS | US REIT, US Treasuries, US Corporate Bonds, EM Bonds, Silver | 3.79% | **0.354** | -17.80% | -27.82% | -0.035 | 0.546 | 0.469 | 1.20 | 1.16% | -0.96 | [-0.23, 1.16] |
...
| EW-AsymVol-Short | US Equity, US Treasuries, US Corporate Bonds, EM Bonds, Commodities | 0.99% | **0.141** | -22.19% | -13.36% | 0.054 | 0.392 | 0.444 | 1.00 | 0.00% | -1.17 | [-0.44, 1.13] |
...
**EW-Short-LS** — combo: US REIT, US Treasuries, US Corporate Bonds, EM Bonds, Silver

- Net ann ret 3.79% · Sharpe 0.354 · MaxDD -17.80% · both-down -27.82% · Upβ -0.035 / Dnβ 0.546 · Dn-corr 0.469 · gross 1.20 · lev cost 1.16%/yr · DSR -0.96 · Sharpe CI [-0.23, 1.16]
...
- Net ann ret 0.99% · Sharpe 0.141 · MaxDD -22.19% · both-down -13.36% · Upβ 0.054 / Dnβ 0.392 · Dn-corr 0.444 · gross 1.00 · lev cost 0.00%/yr · DSR -1.17 · Sharpe CI [-0.44, 1.13]
