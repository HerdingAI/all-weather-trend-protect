...
- **TRAIN rank:** #1 (TRAIN score 81.8, z = +2.80)
...
- **Deflated Sharpe (annualized): -1.408**  (raw minus the luck-of-many-trials benchmark).
...
|---|---:|---:|---:|---:|---:|---:|---:|
| LS-TSMOM | 50 | 0.121 | -9.79% | -22.20% | n/a | 51.0 | 26 |
...
| Winner TRAIN score (z) | +2.80 | OUTLIER — overfit risk |
| Top-10 TRAIN in Top-20 TEST | 0% | selection stability |
| Spearman TRAIN↔TEST score | -0.52 | rank persistence |
...
- Rolling Deflated Sharpe = -0.949  (P>0 = 0.00)
...
| RP-LS-Overlay | US Equity, Preferred Stock, US Treasuries, US Corporate Bonds, US Municipal Bonds | 4.31% | **0.539** | -13.31% | -30.07% | 0.369 | 0.502 | 0.749 | 1.30 | 1.74% | -0.77 | [-0.01, 1.24] |
...
**RP-LS-Overlay** — combo: US Equity, Preferred Stock, US Treasuries, US Corporate Bonds, US Municipal Bonds

- Net ann ret 4.31% · Sharpe 0.539 · MaxDD -13.31% · both-down -30.07% · Upβ 0.369 / Dnβ 0.502 · Dn-corr 0.749 · gross 1.30 · lev cost 1.74%/yr · DSR -0.77 · Sharpe CI [-0.01, 1.24]
